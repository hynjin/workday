...
export const copy = {
  ko: {
    ...
    library: {
      ...
      categories: "카테고리", categoryHelp: "작업을 묶는 폴더입니다. 카테고리 자체는 할 일이 아닙니다.", newCategory: "새 카테고리 이름", addCategory: "카테고리 만들기", noCategory: "카테고리를 먼저 만들어 주세요.",
  ...
  en: {
    nav: ["Workday", "Task library · Plan", "Summary"],
    library: {
      ...
      categories: "Categories", categoryHelp: "Folders that group tasks. A category is not a task itself.", newCategory: "New category name", addCategory: "Create category", noCategory: "Create a category first.",
